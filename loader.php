...
// Loader Usage
// ============
// 1. replace all occurrences of autosave_net_ in this file with the plugin namespace prefix eg. my_plugin_
...
// $instance = new autosave_net_loader($args);				// instantiates loader class
// (ie. search and replace 'autosave_net_' with 'my_plugin_' function namespace)
...
if ( !class_exists( 'autosave_net_loader' ) ) {
	class autosave_net_loader {
...
add_action( 'plugins_loaded', 'autosave_net_load_prefixed_functions', 0 );

if ( !function_exists( 'autosave_net_load_prefixed_functions' ) ) {
	function autosave_net_load_prefixed_functions() {
		...
		if ( !function_exists( 'autosave_net_get_autosave_net_slug' ) ) {
			function autosave_net_get_autosave_net_slug( $f ) {
		...
		if ( !function_exists( 'autosave_net_loader_instance' ) ) {
			function autosave_net_loader_instance() {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
		...
		if ( !function_exists( 'autosave_net_freemius_instance' ) ) {
			function autosave_net_freemius_instance() {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
		...
		if ( !function_exists( 'autosave_net_plugin_data' ) ) {
			function autosave_net_plugin_data() {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
		...
		if ( !function_exists( 'autosave_net_plugin_version' ) ) {
			function autosave_net_plugin_version() {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Set Pro Namespace
		// -----------------
		if ( !function_exists( 'autosave_net_pro_namespace' ) ) {
			function autosave_net_pro_namespace( $pronamespace ) {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Add Settings
		// ------------
		if ( !function_exists( 'autosave_net_add_settings' ) ) {
			function autosave_net_add_settings() {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Get Defaults
		// ------------
		if ( !function_exists( 'autosave_net_default_settings' ) ) {
			function autosave_net_default_settings( $key = false ) {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Get Options
		// -----------
		if ( !function_exists( 'autosave_net_get_options' ) ) {
			function autosave_net_get_options() {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Get Setting
		// -----------
		if ( !function_exists( 'autosave_net_get_setting' ) ) {
			function autosave_net_get_setting( $key, $filter = true ) {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'autosave_net_get_settings' ) ) {
			function autosave_net_get_settings( $filter = true ) {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Reset Settings
		// --------------
		if ( !function_exists( 'autosave_net_reset_settings' ) ) {
			function autosave_net_reset_settings() {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Update Settings
		// ---------------
		if ( !function_exists( 'autosave_net_update_settings' ) ) {
			function autosave_net_update_settings() {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Delete Settings
		// ---------------
		if ( !function_exists( 'autosave_net_delete_settings' ) ) {
			function autosave_net_delete_settings() {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Message Box
		// -----------
		if ( !function_exists( 'autosave_net_message_box' ) ) {
			function autosave_net_message_box( $message, $echo = false ) {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Settings Header
		// ---------------
		if ( !function_exists( 'autosave_net_settings_header' ) ) {
			function autosave_net_settings_header() {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Settings Page
		// -------------
		if ( !function_exists( 'autosave_net_settings_page' ) ) {
			function autosave_net_settings_page() {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'autosave_net_settings_table' ) ) {
			function autosave_net_settings_table() {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'autosave_net_settings_row' ) ) {
			function autosave_net_settings_row( $option, $setting ) {
				$namespace = autosave_net_get_autosave_net_slug( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
